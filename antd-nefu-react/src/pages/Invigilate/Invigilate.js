  ...
  return (
    ...
    >
      ...
      <FormItem labelCol={{ span: 5 }} wrapperCol={{ span: 15 }} label="所需人数">
        {form.getFieldDecorator('peopleNum', {
...
class UpdateForm extends PureComponent {
  ...
  renderContent = (currentStep, formVals) => {
    ...
    if (currentStep === 1) {
      return [
        <FormItem key="target" {...this.formLayout} label="监考人数">
          {form.getFieldDecorator('target', {
            ...
            <Select style={{ width: '100%' }}>
              ...
              <Option value="1">三人</Option>
            </Select>
          )}
        </FormItem>,
        <FormItem key="template" {...this.formLayout} label="监考教师">
    ...
    if (currentStep === 2) {
      return [
        ...
        <FormItem key="frequency" {...this.formLayout} label="结束时间">
    ...
    return [
      ...
      <FormItem key="desc" {...this.formLayout} label="地点">
        {form.getFieldDecorator('desc', {
...
class TableList extends PureComponent {
  ...
  handleSearch = e => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const values = {
        ...fieldsValue,
        startDate:  moment(fieldsValue.startDate).format('YYYY-MM-DD HH:mm:ss'),
      };
